...
EXT_RAM_BSS_ATTR static httpd_handle_t _server;
EXT_RAM_BSS_ATTR static int _port;
EXT_RAM_BSS_ATTR rest_server_context_t *rest_context;
EXT_RAM_BSS_ATTR RingbufHandle_t messaging;
